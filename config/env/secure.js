...
module.exports = {
	port: 443,
	db: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://localhost/emmaus475',
	// db: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://localhost/emmaus',
	assets: {
		lib: {
			css: [
